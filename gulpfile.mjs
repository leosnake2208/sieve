...
const appPackageMacOSx64 = gulp.series(
  app.packageApp,
  app.packageMacOSx64
);
appPackageMacOSx64.displayName = 'app:package-macos-x64';

const appZipMacOSx64 = gulp.series(
  appPackageMacOSx64,
  app.zipMacOSx64
);
appZipMacOSx64.displayName = 'app:zip-macos-x64';
